...
function SoftwareDevelopment() {
  ...
  const offerings = [
    {
      ...
      description:
        "Build powerful, scalable web applications tailored to your unique business requirements and workflows.",
      features: [
        "Custom Architecture",
        "API Integration",
        "Real-time Features",
    ...
    },
    {
      ...
      description:
        "Native desktop applications for Windows, macOS, and Linux with optimal performance and user experience.",
      features: [
        "Cross-Platform",
        "Native Performance",
    ...
    },
    {
      ...
      description:
        "Enterprise Resource Planning systems designed to streamline your business operations and improve efficiency.",
      features: [
        "Module Integration",
        "Workflow Automation",
        "Reporting & Analytics",
    ...
    },
    {
      ...
      description:
        "Modern web applications with responsive design and seamless user experiences across all devices.",
      features: [
        "Responsive Design",
        "Fast Performance",
        "SEO Optimized",
    ...
    },
    {
      ...
      description:
        "Cloud-based Software as a Service solutions with subscription models and multi-tenant architecture.",
      features: [
        "Multi-Tenancy",
    ...
    },
    {
      ...
      description:
        "End-to-end custom software solutions built from the ground up to solve your specific business challenges.",
      features: [
    ...
    },
    {
      ...
      description:
        "Complete front-end and back-end development services for robust, feature-rich applications.",
      features: [
        "Frontend & Backend",
        "Database Design",
        "API Development",
    ...
    },
    {
      ...
      title: "Cloud & DevOps",
      description:
        "Cloud infrastructure setup and DevOps practices for continuous integration and deployment.",
      features: [
        "CI/CD Pipeline",
        "Cloud Migration",
  ...
  const features = [
    {
      ...
      description:
        "Built with security best practices to protect your data and users from threats.",
    },
    {
      icon: <Zap className="w-10 h-10" />,
      title: "High Performance",
      description:
        "Optimized code and architecture for fast, responsive applications that scale.",
    },
    {
      icon: <Settings className="w-10 h-10" />,
      title: "Maintainable Code",
      description:
        "Clean, well-documented code that's easy to maintain and extend over time.",
    },
    {
      icon: <TrendingUp className="w-10 h-10" />,
      title: "Scalable Solutions",
      description:
        "Architecture designed to grow with your business and handle increasing demands.",
    },
  ];
  ...
  const developmentProcess = [
    ...
    },
    {
      ...
      description:
        "User interface design, system architecture planning, and interactive prototypes for validation.",
    },
    {
      number: "03",
      title: "Development",
    ...
    },
    {
      ...
      title: "Deployment",
      description:
        "Smooth deployment to production with monitoring, documentation, and training.",
    },
    {
      number: "06",
      title: "Support & Maintenance",
      description:
        "Ongoing support, bug fixes, updates, and feature enhancements as needed.",
    },
  ];
  ...
  return (
    <div className="w-full overflow-x-hidden">
      <Title>Software Development | PRK TECH</Title>
      <Meta
        name="description"
        content="Build scalable and reliable digital products with PRK TECH’s custom software development services tailored to your business."
      />
        ...
        <div className="relative z-10 w-full px-8 py-12">
          <div className="max-w-5xl space-y-6">
            ...
            <div
              ...
              style={{ fontFamily: "Stack Sans Headline, sans-serif" }}
            >
              <span className="text-white drop-shadow-lg">Expertise in</span>
            ...
            >
              From enterprise applications to cloud solutions, we develop
              robust, scalable software that transforms your business processes
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-16">
            <h2
              ...
              style={{ fontFamily: "Stack Sans Headline, sans-serif" }}
            >
              <span className="text-blue-950">Our Tech </span>
              <span className="bg-gradient-to-r from-yellow-500 to-yellow-600 bg-clip-text text-transparent">
                Stack
              </span>
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="bg-gradient-to-br from-blue-50 to-yellow-50 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 text-center group"
              >
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-16">
            <h2
              ...
              style={{ fontFamily: "Stack Sans Headline, sans-serif" }}
            >
              <span className="text-blue-950">Our Development </span>
              <span className="bg-gradient-to-r from-yellow-500 to-yellow-600 bg-clip-text text-transparent">
                Process
              </span>
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <h2
                ...
                style={{ fontFamily: "Stack Sans Headline, sans-serif" }}
              >
                <span className="text-blue-950">Partner With </span>
                <span className="bg-gradient-to-r from-yellow-500 to-yellow-600 bg-clip-text text-transparent">
                  The Best
                </span>
              </h2>
              <p
                ...
                style={{ fontFamily: "Stack Sans Text, sans-serif" }}
              >
                We don't just write code—we build solutions that solve real
                business problems. Our team combines technical expertise with
                business acumen to deliver software that drives measurable
                results.
              </p>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-950 to-yellow-900 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-8 text-center relative z-10">
          ...
          <p
            ...
            style={{ fontFamily: "Stack Sans Text, sans-serif" }}
          >
            Let's discuss your project and create a software solution that
            exceeds your expectations. Our team is ready to turn your ideas into
            reality.
          </p>
