...
${formData.message}
  ...
  return (
    <div className="w-full overflow-x-hidden">
      <Title>Contact Us | PRK</Title>
      <Meta name="description" content="Get in touch with PRK for web design, development, digital marketing, and SEO services in Bangalore." />
            ...
            <div className="lg:col-span-2 space-y-8">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-8">
                  Whether you're looking to build a new website, improve your digital presence, 
                  or explore SEO opportunities, we're here to help bring your vision to life.
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-blue-900 mb-1">Email Us</h3>
                      <a 
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-blue-900 mb-1">Visit Us</h3>
                      <p className="text-gray-700">PRK Global 360</p>
                      <p className="text-gray-700">Bangalore, India</p>
                      <a 
                        href="https://maps.app.goo.gl/U5NKLM6DwXYwJotPb"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 text-orange-500 hover:text-orange-600 mt-2 font-medium"
                      >
                        View on Map
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-blue-900 mb-1">Business Hours</h3>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg">
                ...
                <div className="flex gap-4">
                  <a
                    href="#"
                    className="w-10 h-10 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform"
                  >
            ...
            <div className="lg:col-span-3">
              <div className="bg-white rounded-2xl p-8 shadow-2xl">
                <h3
                  ...
                  style={{ fontFamily: "Sigmar One, sans-serif" }}
                >
                  <span className="text-blue-900">Send Us a </span>
                  <span className="bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent">
                    Message
                  </span>
                </h3>
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-12">
            <h2
              ...
              style={{ fontFamily: "Sigmar One, sans-serif" }}
            >
              <span className="text-blue-900">Find Us </span>
              <span className="bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent">
                Here
              </span>
            </h2>
            <p className="text-lg text-gray-700">PRK Global 360, Bangalore</p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-900 to-orange-900 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-8 text-center relative z-10">
          ...
          <p className="text-xl text-white/90 mb-8 leading-relaxed">
            Let's transform your digital presence together. Contact us today for a free consultation.
          </p>
          <a
            href="mailto:Ceo@prktechindia.in"
